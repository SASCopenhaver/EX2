...
//		 	} 		
	...
	function setupApplication()
	{
		...
		application.httphost = CGI.HTTP_HOST;								 //application.httphost = "127.0.0.1:8600"
																			...
																			//CGI.SCRIPT_NAME = "/EX2/index.cfm "				
		var vPathRoot = CGI.SCRIPT_NAME.substring(1);						// vPathRoot = "EX2/index.cfm"
			vPos = vPathRoot.indexOf("/");
		application.path.root = vPathRoot.substring(0,vPos);				// application.path.root = "EX2"
		app.assets = "/" & application.path.root & "/assets/";
			app.img = app.assets & "img/";
			app.icons = app.img & "icons/";
			app.icons_svg = app.img & "icons_svg/";
			app.assets_styles =  app.assets & "styles/";
				app.css_modules = app.assets_styles & "css_modules/";
		
		app.builds = "/" & application.path.root & "/builds/";
			app.build_styles = app.builds & "styles/";
			
		app.ui = "/" & application.path.root & "/ui/";
		
		
//		application.path.cfc = "/" & application.path.root & "/cfc/";
//		application.path.css_src = "/" & application.path.root & "/css/src/";
//		application.path.css_dest = "/" & application.path.root & "/css/dest/";
